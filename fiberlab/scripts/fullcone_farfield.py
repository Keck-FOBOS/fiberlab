...
class FullConeFarField(scriptbase.ScriptBase):
    ...
    def main(args):
        ...
        radius_img, img, radius, flux \
                = fullcone.fullcone_farfield_output(img_file, bkg_file=bkg_file,
                                                    threshold=args.threshold,
                                                    pixelsize=args.pixelsize,
                                                    distance=args.distance, plot_file=plot_file,
                                                    snr_img=args.snr_img, ring_box=args.ring_box)
